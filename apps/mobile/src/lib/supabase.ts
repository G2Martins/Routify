...
// Web: sessão em cookie (formato do @supabase/ssr), o mesmo que o painel ADM (Next)
// lê no servidor — login único para app e painel no mesmo domínio. Nativo: AsyncStorage.
